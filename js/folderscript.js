...
education = {
  "data": [
    ...
    { "name": "c++", "link": "./img/CPP.jpg", "info": "Stephen started using C++ in early 2013. He first learned how to use C++ as a functional language, and eventually learned the basic principles of Classes and Object creation within C++ in 2015." },
    ...
    { "name": "java", "link": "./img/java.jpg", "info": "Stephen Started using Java in late 2014, he enjoys java mostly for its portability and has created several applications that are being utilized for demonstration and training purposes in conjuction with other platforms." },
    { "name": "webdev", "link": "./img/html.jpg", "info": "Javascript/CSS/HTML, Stephen initially learned these languages to create his own website and has since expanded his knowledge to include various web development techniques, which he applies in his professional projects." },
